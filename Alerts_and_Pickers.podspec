#
#  Be sure to run `pod spec lint Alerts_and_Pickers.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Pablo Bórquez"
  # spec.authors            = { "Pablo Bórquez" => "pablo.borquez@coppel.com" }
  # spec.social_media_url   = "https://twitter.com/Pablo Bórquez"
